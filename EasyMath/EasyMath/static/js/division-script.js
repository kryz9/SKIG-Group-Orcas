...
document.querySelector("#startreset").onclick = () =>
{
    ...
    // if we are not playing
        ...
        document.querySelector("#startreset").innerHTML = "Ulang Semula";
        //start countdown
        startCountdown();
        //generate new Q&A
        generateQA();
...
function startCountdown()
{
    action = setInterval(() =>
    {
        ...
        if (timeRemaining == 0) {
            ...
            document.querySelector("#gameOver").innerHTML = "<p>Masa Tamat!</p><p>Skor anda adalah : " + score + ".</p>";
            //hide countdown
            ...
            document.querySelector("#startreset").innerHTML = "Mula Permainan";
        }
    }, 1000);
}
